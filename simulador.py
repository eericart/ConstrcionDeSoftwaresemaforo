  ...
  def draw (self):
    ...
    for street in self.streets:
        ...
        for inter in street.intercessiones:
            pygame.draw.rect(self.screen, Color(inter.semaforo.estadoX),inter.rect,1)
...
def main():
    ...
    car1 = vehiculo.Car(0,395,direccion.Directions().east)
    car5 = vehiculo.Car(500,430,direccion.Directions().east)
    car6 = vehiculo.Car(175,544,direccion.Directions().north)
    car4 = vehiculo.Car(147,200,direccion.Directions().north)
    ...
    #Preparar
    streetPrinciparl.cars.extend([car,car1,car5])
    street.cars.extend([car4,car6])
